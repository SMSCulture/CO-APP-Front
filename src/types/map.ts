...
export interface MapViewport { latitude:number; longitude:number; zoom:number; bounds:MapBounds }
...
export interface EventMapPin { entityKind:'event'; eventId:string; title:string; coordinate:{latitude:number;longitude:number}; priceLabel:string }
