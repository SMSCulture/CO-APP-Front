...
/** Matches the Search page's look (search bar + pill row + vertical list of row cards) — see VenuesScreen.tsx for the full rationale. */
export function RestaurantsScreen() {
  ...
  return (
    <Screen>
      <DetailScreenHeader title="Restaurants" subtitle={city} />
